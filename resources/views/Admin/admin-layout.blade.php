        ...
        <nav class="navbar navbar-expand-lg d-flex justify-content-between">
            ...
            <div class="" id="headerNav">
                <ul class="navbar-nav">
                            ...
                            <a href="#">
                                <div class="header-notif">
                                  ...
                                  <span class="notification-badge">
                                    <img src="{{asset('backend/images/avatars/profile-image.png')}}" alt="">
                                  </span>
                                    </div>
                                    <div class="notif-text">
                                        <p>faucibus dolor in commodo lectus mattis</p>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link profile-dropdown" href="#" id="profileDropDown" role="button" data-bs-toggle="dropdown" aria-expanded="false"><img src="{{asset('backend/images/avatars/profile-image.png')}}" alt=""></a>
                        <div class="dropdown-menu dropdown-menu-end profile-drop-menu" aria-labelledby="profileDropDown">
                            ...
                            <a class="dropdown-item" href="{{url('/admin')}}"><i data-feather="unlock"></i>Khóa</a>
                            <a class="dropdown-item" href="{{url('admin/logout')}}"><i data-feather="log-out"></i>Đăng xuất</a>
                        </div>
                    </li>
                </ul>
            </div>
    ...
    <div class="page-sidebar">
        <ul class="list-unstyled accordion-menu">
            ...
            <li class="active-page">
                <a href="{{url('admin/dashboard')}}"><i data-feather="home"></i>Trang chủ</a>
            </li>
            <li class="sidebar-title">
                Tài khoản
            </li>
            ...
            <li>
                ...
                <ul class="">
                    <li><a href="{{url('admin/get-all-category')}}"><i class="far fa-circle"></i>Danh mục</a></li>
{{--                    <li><a href="{{url('admin/add-category')}}"><i class="far fa-circle"></i>Thêm danh mục</a></li>--}}
                    <li><a href={{route('admin.get-brand')}}><i class="far fa-circle"></i>Thương hiệu</a></li>
                    <li><a href={{route('admin.get-product')}}><i class="far fa-circle"></i>Quản lý sản phẩm</a></li>
