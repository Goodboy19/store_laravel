            ...
            <div class="card login-box-container">
                <div class="card-body">
                    <div class="authent-logo">
                        <img src="<?php echo e(asset('backend/images/logo@2x.png')); ?>" alt="">
                    </div>
                    ...
                    <form method="POST" action="<?php echo e(url('admin/login-dasboard')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
...
<?php /**PATH /Users/goodboy/Desktop/NAM/Learning/Laravel/project_store/resources/views/admin/admin-login.blade.php ENDPATH**/ ?>