...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="brand_status" class="form-select" aria-label="Default select example">
                                <option value="0" <?php echo e(old('brand_status')==0 || $brandDetail->brand_status ==0 ?'selected':false); ?>>Ẩn</option>
                                <option value="1" <?php echo e(old('brand_status')==1 || $brandDetail->brand_status ==1 ?'selected':false); ?> >Hiển thị</option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <a style="background:#ffb703" class="btn btn-outline-light" href=<?php echo e(route('admin.get-brand)); ?>>Quay lại thương hiệu </a>
                        </div>
                    </form>
...
<?php echo $__env->make('admin.admin-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> ?><?php /**PATH /Users/goodboy/Desktop/NAM/Learning/Laravel/project_store/resources/views/admin/brandEdit.blade.php ENDPATH**/ ?>