                ...
                <div class="col-md-12 col-lg-8">
                    ...
                    <form method="POST" action="<?php echo e(url('/admin/update-category')); ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="category_name" class="form-control"  value="<?php echo e(old('category_name') ?? $categoryDetail->category_name); ?>">
...
<?php echo $__env->make('admin.admin-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/goodboy/Desktop/NAM/Learning/Laravel/project_store/resources/views/admin/edit-category.blade.php ENDPATH**/ ?>