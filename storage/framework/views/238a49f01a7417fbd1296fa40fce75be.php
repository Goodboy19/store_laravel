            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            <li><a href="<?php echo e(route('checkOut')); ?>"><i class="fa fa-user"></i> Tài khoản</a></li>
                            <li><a href="#"><i class="fa fa-star"></i> Yêu thích</a></li>
                            <li><a href="checkout.html"><i class="fa fa-crosshairs"></i> Thanh toán</a></li>
                            <li><a href="<?php echo e(route('showCart')); ?>"><i class="fa fa-shopping-cart"></i> Giỏ hàng</a></li>
                            <li><a href="<?php echo e(route('checkOut')); ?>"><i class="fa fa-lock"></i> Đăng nhập</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="left-sidebar">
                    ...
                    <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                        <div class="panel panel-default">
                            <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $categoryItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a href="#"><?php echo e($categoryItem->category_name); ?></a></h4>
                                </div>
