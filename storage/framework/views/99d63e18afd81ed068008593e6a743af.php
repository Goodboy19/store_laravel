                                    ...
                                    <?php if(!empty('$categories')): ?>
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div >
                                                        <a style="color: blue" href=<?php echo e(url('admin/edit-category',$item->category_id)); ?>>Sửa</a>
                                                    </div>

                                                </td>
                                                <td>
                                                    <div >
                                                        <a onclick="return confirm('Bạn có chắc chắn muốn xóa?')" style="color: red" href="<?php echo e(url('/admin/destroy-category',$item->category_id)); ?>">Xóa</a>
                                                    </div>
...
<?php echo $__env->make('admin.admin-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/goodboy/Desktop/NAM/Learning/Laravel/project_store/resources/views/Admin/category-list.blade.php ENDPATH**/ ?>