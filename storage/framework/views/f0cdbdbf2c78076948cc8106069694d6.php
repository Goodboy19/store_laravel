    ...
    <div class="page-content">
        <div class="main-wrapper">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <tr>
                                        <th scope="row"><img src="<?php echo e(asset('backend/images/avatars/profile-image.png')); ?>" alt="">Anna Doe</th>
                                        <td>Modern</td>
                                        <td>#53327</td>
                                        <td>$20</td>
                                    ...
                                    <tr>
                                        <th scope="row"><img src="<?php echo e(asset('backend/images/avatars/profile-image.png')); ?>" alt="">John Doe</th>
                                        <td>Alpha</td>
                                        <td>#13328</td>
                                        <td>$25</td>
                                    ...
                                    <tr>
                                        <th scope="row"><img src="<?php echo e(asset('backend/images/avatars/profile-image.png')); ?>" alt="">Nina Doe</th>
                                        <td>Space</td>
                                        <td>#54773</td>
                                        <td>$20</td>
                                        <td><span class="badge bg-success">Paid</span></td>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-4">
                    <div class="card">
                        <img src="<?php echo e(asset('backend/images/card-bg.png')); ?>" class="card-img-top" alt="...">
                        <div class="card-body">
...
<?php echo $__env->make('admin.admin-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/goodboy/Desktop/NAM/Learning/Laravel/project_store/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>