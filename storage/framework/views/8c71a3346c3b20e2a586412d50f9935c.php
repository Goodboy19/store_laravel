                                    ...
                                    <?php if(($brand->count())>0): ?>
                                        ...
                                        <?php $__currentLoopData = $brand; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div >
                                                            <a  style="color: mediumspringgreen" href=<?php echo e(route('admin.edit-brand',$item->brand_id)); ?>>Sửa</a>
                                                    </div>

                                                </td>
                                                <td>
                                                    <div >
                                                        <a  style="color: red" href=<?php echo e(route('admin.soft-delete-brand',$item->brand_id)); ?>>Xóa</a>
                                                    </div>
...
<?php echo $__env->make('admin.admin-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/goodboy/Desktop/NAM/Learning/Laravel/project_store/resources/views/Admin/brand-list.blade.php ENDPATH**/ ?>