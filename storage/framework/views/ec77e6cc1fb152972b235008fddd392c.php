                ...
                <div class="col-md-12 col-lg-8">
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="brand_name" class="form-control"  value="<?php echo e(old('brand_name')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input name="brand_desc" class="form-control"  value="<?php echo e(old('brand_desc')); ?>">
...
<?php echo $__env->make('admin.admin-layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/goodboy/Desktop/NAM/Learning/Laravel/project_store/resources/views/admin/add-brand.blade.php ENDPATH**/ ?>